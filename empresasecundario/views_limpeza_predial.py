...
from empresasecundario.forms_limpeza_predial import EmpresaSecundariaLimpezaPredialForms
...
def empresas_limpeza_predial(request, userid):
    ...
    return generic_view(
        ...
        form_class=EmpresaSecundariaLimpezaPredialForms,
...
def editar_empresa_limpeza_predial(request, userid, id_random):
    ...
    return edit_generic_view(
        ...
        redirect_url_name='empresas_limpeza_predial',
        redirect_close_button='empresas_limpeza_predial',
        permission_edit=permission_edit,
