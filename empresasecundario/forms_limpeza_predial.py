...
class EmpresaSecundariaLimpezaPredialForms(forms.ModelForm):
    def __init__(self, *args, request, userid=str, **kwargs):
        super(EmpresaSecundariaLimpezaPredialForms, self).__init__(*args, **kwargs)
        ...
        if userid:
            ...
            self.fields['setor'].choices = [('Limpeza predial', 'Limpeza predial')]
