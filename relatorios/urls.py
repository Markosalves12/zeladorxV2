...
from relatorios.views_relatorios_jardinagem_xlsx import (relatorios_de_servicos_xlsx_concluidos,
                                                         relatorios_de_servicos_xlsx_agendados)
from relatorios.views_relatorios_jardinagem_pdf import (relatorios_de_servicos_pdf_concluidos,
                                                        relatorios_de_servicos_pdf_agendados)
from relatorios.relatorio_de_servicos_jardinagem_xlsx import exportar_relatorio_de_serivos_excel
from relatorios.relatorio_de_servicos_jardinagem_pdf import exportar_relatorio_de_serivos_pdf
from relatorios.relatorio_de_servicos_na_area_pdf import exportar_relatorio_de_serivos_na_area_pdf
...
urlpatterns = [
    ...
    path('exportar_relatorio_de_serivos_na_area_pdf/<str:id_random>/<str:categoria_servico_zeladoria>', exportar_relatorio_de_serivos_na_area_pdf, name='exportar_relatorio_de_serivos_na_area_pdf'),
]
