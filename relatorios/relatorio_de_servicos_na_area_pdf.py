...
def exportar_relatorio_de_serivos_na_area_pdf(request, id_random, categoria_servico_zeladoria):
    if categoria_servico_zeladoria == 'jardinagem':
    ...
    elif categoria_servico_zeladoria == 'limpeza_predial':
