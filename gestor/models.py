...
class GestorManager(BaseUserManager):
    def create_user(self, email, username, funcao, password=None, empresa=None, status='Mobilizado'):
        if not email:
    ...
    def create_superuser(self, email, username, funcao, password, empresa):
