...
urlpatterns = [
    ...
    path('historico_de_servicos_catologo_de_servicos_jardinagem/<str:id_random>', historico_de_servicos_catologo_de_servicos_jardinagem, name='historico_de_servicos_catologo_de_servicos_jardinagem'),
]