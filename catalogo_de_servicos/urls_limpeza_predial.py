...
urlpatterns = [
    ...
    path('editar_catalogo_de_servicos_limpeza_predial/<str:userid>/<str:id_random>', editar_catalogo_de_servicos_limpeza_predial, name='editar_catalogo_de_servicos_limpeza_predial'),
]
