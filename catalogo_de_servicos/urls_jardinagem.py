...
urlpatterns = [
    ...
    path('editar_catalogo_de_servicos_jardinagem/<str:userid>/<str:id_random>', editar_catalogo_de_servicos_jardinagem, name='editar_catalogo_de_servicos_jardinagem'),
]
